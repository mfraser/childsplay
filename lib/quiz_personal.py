...
# self.logger =  logging.getLogger("childsplay.quiz_personal.Activity")
# self.logger.error("I don't understand logger")
# See SP manual for more info 

module_logger = logging.getLogger("childsplay.quiz_personal")
...
class Activity(quiz.Activity):
  ...
  """
    ...
    def __init__(self,SPGoodies):
        ...
        self.my_datadir = os.path.join(self.SPG.get_libdir_path(),'CPData','Quiz_personalData')
