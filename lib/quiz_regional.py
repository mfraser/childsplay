...
# self.logger =  logging.getLogger("childsplay.quiz_local.Activity")
# self.logger.error("I don't understand logger")
# See SP manual for more info 

module_logger = logging.getLogger("childsplay.quiz_local")
...
class Activity(quiz.Activity):
  ...
  """
    ...
    def __init__(self,SPGoodies):
        ...
        self.logger =  logging.getLogger("childsplay.quiz_regional.Activity")
        self.logger.info("Activity started")
        
        # The location of the activities Data dir
        self.my_datadir = os.path.join(self.SPG.get_libdir_path(),'CPData','Quiz_regionalData')
        self.rchash = utils.read_rcfile(os.path.join(self.my_datadir, 'quiz_regional.rc'))
        self.rchash['theme'] = self.theme
        self.rchash['lang'] = self.lang
    
    def _start_engine(self):
        try:
            self.quizengine = quiz.Engine('regional', self.SPG, \
    ...
    def get_helptitle(self):
        """Mandatory method"""
        return _("Regional Quiz")
    
    def get_name(self):
        """Mandatory method, returnt string must be in lowercase."""
        return "quiz_regional"
    ...
    def get_help(self):
        ...
        " ",
        _("At the top of the screen, you will see a question related to your place of residence."),
